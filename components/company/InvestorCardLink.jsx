...
const InvestorCardLink = ({ name, id }) => {
  return (
    ...
    >
      <h2 className="mb-[10px] h-[60px] text-base font-light leading-[110%] text-gray-dark sm:text-[18px] md:mb-[55px] md:h-[96px] md:text-2xl lg:text-[32px] xl:h-[64px] 2xl:text-[48px]">
        {name.trim()}
      </h2>
