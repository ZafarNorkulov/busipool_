      ...
      <div className="flex h-[65%] flex-col p-[10px] md:p-[30px]">
        ...
        <div>
          <div className="mb-5 h-[55px] md:mb-[28px] md:h-[58px]">
            ...
            <div className="my-[4.5px] h-[2px] rounded-[4.5px] bg-gray-300 md:my-[10px] md:h-[5px] md:rounded-[10px]">
              <div
                className={`h-[2px] rounded-[4.5px] bg-primary md:h-[5px] md:rounded-[10px]`}
                style={{ width: `${percentage}%` }}
              ></div>
            </div>
            <div className="mb-[4.5px] flex justify-between leading-[110%] text-gray-dark md:text-sm">
              <span className="text-xs font-bold">
                {splitEvery3(card?.total_investor_price)} ₽
              </span>
              <span className="text-xs font-light lowercase opacity-70">
                СОБРАНО ИЗ
              </span>
              <span className="text-xs font-bold">
