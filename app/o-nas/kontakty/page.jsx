      ...
      <div className="mb-[100px] bg-secondary py-[100px] 2xl:mb-[150px]">
        ...
        <div className="max-container md:px-[10px]">
          <div className="flex grid-cols-12 flex-col gap-[30px] sm:grid lg:gap-[60px] 2xl:gap-[100px]">
            <div className="relative col-span-12 h-[200px] xs:h-[300px] flex-auto shrink-0 self-stretch border-0 outline-none md:h-[400px] md:flex-1 lg:col-span-6 2xl:h-[550px] 2xl:col-span-6 extraWide:h-auto">
              <iframe
